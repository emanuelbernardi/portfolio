...
export const CONFIG = {
  ...
  bio: "Emanuel Bernardi Full Stack Developer  Data Engineer Desenvolvedor Full Stack com mais de 4 anos de experiência construindo aplicações completas — do back-end robusto à interface que o usuário realmente quer usar. Trabalho com PHP, React, Next.js e Node.js no dia a dia, sempre focado em código limpo, performance e entregas que fazem sentido para o negócio. Além do desenvolvimento, também atuo no universo de dados como: Power BI, análise de dados e Data Engineering com Python, o que me permite não só construir sistemas, mas também extrair inteligência deles. Essa combinação entre software e dados é o que me diferencia — consigo enxergar o produto e os números por trás dele. Se você busca alguém que transita com naturalidade entre uma API bem arquitetada, um dashboard analítico e uma interface moderna, é aqui.",
  bioEnglish: "Emanuel Bernardi — Full Stack Developer & Data Engineer Full Stack Developer over 4 years of experience building end-to-end applications — from solid back-end architecture to interfaces users actually enjoy using. Day-to-day, I work with PHP, React, Next.js, and Node.js, with focus on clean code, performance, and delivering work that makes real business sense. Beyond development, I also operate in the data space: Power BI, data analysis, and Data Engineering with Python. This means I don't just build systems — I extract intelligence from them. That overlap between software and data is what sets me apart. I can see both the product and the numbers behind it. If you're looking for someone who moves naturally between a well-architected API, an analytical dashboard, and a modern UI — you're in the right place.",
  
  // --- Links ---
  githubUser: "emanuelbernardi", // Seus repos serão puxados automaticamente
  linkedin: "https://linkedin.com/in/emanuel-bernardi-596169215/",
  email: "emanuel.aobernardi@gmail.com",
